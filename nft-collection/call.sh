...
# echo 'addCollection'
# # not working
# # erdpy --verbose contract call  --chain="D" ${contractAddr} --pem="../../wallet-owner.pem" --gas-limit=80000000 --function="ESDTTransfer" --arguments    str:EGLD 1 "str:addCollection" "str:FirstCollection_______________________________" "str:FirstCollection" "str:png" 10  100000000 200000000  str:EGLD "str:FirstToken" "str:FIRST" 0 0x00000003616263 5  1 --recall-nonce --send --proxy="https://devnet-gateway.elrond.com" 

# erdpy --verbose contract call  --chain="D" ${contractAddr} --pem="../../wallet-owner.pem" --gas-limit=80000000 --function="addCollection" --arguments   "str:ThirdCollection_______________________________" "str:Thirdrand" "str:png" 10  100000000 20000000000000  str:EGLD "str:FirstToken" "str:FIRST" 0 0x00000003616263 5 50000000000000000 --recall-nonce --send --proxy="https://devnet-gateway.elrond.com"  --value=50000000000000000
